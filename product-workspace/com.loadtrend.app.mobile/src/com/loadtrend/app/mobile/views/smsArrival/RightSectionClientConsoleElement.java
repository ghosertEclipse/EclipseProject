...
public class RightSectionClientConsoleElement extends RightSectionClient {
    ...
    public SelectionAdapter createContentByElement(final Element element, final Composite rightSectionClient, FormToolkit kit) {
        ...
        labelName = Messages.getString(MessagesConstant.SMSArrivalView_COMMANDLINE);
        ...
        final String queryReplyString = Messages.getString(MessagesConstant.SMSArrivalView_EXECUTECOMMAND_STRING, queryCode.getValue(), commandLine.getValue(), mobileNumber);
